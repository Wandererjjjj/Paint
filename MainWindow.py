...
class Ui_MainWindow(object):
    ...
    # Функция retranslateUi принимает MainWindow в качестве аргумента и переводит
    # текстовые элементы пользовательского интерфейса на другой язык.

    def retranslateUi(self, MainWindow):
        # QtCore.QCoreApplication.translate используется для перевода текста
        # на другой язык. Здесь устанавливается заголовок главного окна.
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "Piecasso"))

        # Устанавливаются переводы для различных меню и панелей инструментов.
        ...
        # Устанавливаются переводы для различных действий, таких как копирование,
        # открытие и сохранение изображений, изменение шрифта и т.д.
